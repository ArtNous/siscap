			...
			$('#ventana').delegate( "#btnGuardar", 'click', function(){	
				...
				Papa.parse(archivos[0], 
				{
					complete: function(resultado)
					{
						...
						$.ajax({
							type: "POST",
							url: 'controlador/cargaAhorros.php',
							data: 'dato='+JSON.stringify(json)+'&codmes='+codMes+"&desde="+desde+"&hasta="+hasta,
							beforeSend: function(){
...
<div id='ventana'  style="width:600px;">
		...
		<div class='titular'>CARGA MASIVA DE AHORROS</div>		
