			...
			$('#ventana').delegate( "#btnGuardar", 'click', function(){	
				...
				Papa.parse(archivos[0], 
				{
					complete: function(resultado)
					{
						...
						$.ajax({
							type: 'POST',
							url: 'controlador/cargaSueldo.php',
								...
								switch(dato){
									...
									case 2:
										swal("Trabajador no existe",
											"El trabajador con la cedula "+respuesta.trabajador+" no existe, ingreselo al sistema y vuelva a cargar los datos por favor.",
											"warning");
										break;
									default:
										swal("Error",
...
<div id='ventana'  style="width:600px;">
		...
		<div class='titular'>CARGA MASIVA DE SUELDOS</div>		
