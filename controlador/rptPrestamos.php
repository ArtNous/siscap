...
class PDF_MC_Table extends FPDF{
    ...
    function Header(){
        ...
        $this->Cell(130,7,utf8_decode('RELACIÓN DE PRÉSTAMOS'),0,0,'C');
	...
	function mostrar_trabajador($cedula){
			...
			$foto = '../files/'.$cedula.'.jpg';
			if (file_exists($foto)){
			   //echo "El fichero existe";
			   $this->Image($foto,185,54,17,22);
			}else{
			   //echo "El fichero no existe";
			   $this->SetFillColor(31, 43, 119);  $this->SetLineWidth(0.1); $this->RoundedRect(185,54, 17, 22, 1);
			   $this->Cell(31,22,utf8_decode("Foto"),0,0,'C');
			}
