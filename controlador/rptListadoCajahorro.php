...
class PDF_MC_Table extends FPDF{
    ...
    function Header(){
        ...
        $this->Cell(130,5,'RESUMEN DE CAJA AHORRO',0,0,'C');
	...
	function mostrar_detalle(){
			...
			$this->Ln(8);
				...
				$col[] = array('text' => utf8_decode('Saldo Ahorrado'),   'width' => '36', 'height' => $this->alto, 'align' => 'C', 'font_name' => 'Arial', 'font_size' => $this->fuente, 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.05', 'linearea' => 'LTBR');
				$columns[] = $col;  
				$this->SetX(12);
